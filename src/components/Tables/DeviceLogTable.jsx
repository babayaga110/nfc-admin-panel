...
export default function DeviceLogTable({ data }) {
          ...
          >
            <thead>
              <tr>
                ...
                <th style={{ width: 100, padding: "12px 6px" }}>Change By</th>
                <th style={{ width: 100, padding: "12px 6px" }}>Updated At</th>
                <th style={{ width: 80, padding: "12px 6px" }}>Address</th>
              ...
              {currentRows?.length > 0 ? (
                currentRows?.map((row, index) => (
                  <tr key={row.id}>
                    ...
                    <td>
                      <Typography level="body-xs">{row?.changedBy}</Typography>  
                    </td>
                    ...
                    <td>
                      <Typography level="body-xs">
                        ...
                        {dayjs(row?.lastStatusChangeTime).format("MMMM D, YYYY h:mm A")}
                      </Typography>
                    </td>
                    <td>
