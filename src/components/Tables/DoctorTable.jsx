...
import { appState, setAlertLoading, setSelectedDoctor } from "../../reduxStore/Slice/appSlice";
...
export default function DoctorTable({ data }) {
  ...
  const fetchAdmins = async () => {
    ...
    try {
      let data = []
      const querySnapshot = await getDocs(collection(db_firestore, "docts"));
          ...
          >
            <thead>
              <tr>
                ...
                <th style={{ width: 60, padding: "12px 6px" }}>AVATAR</th>
                <th style={{ width: 140, padding: "12px 6px" }}>NAME</th>
                <th style={{ width: 240, padding: "12px 6px" }}>DESIGNATION</th>

                {/* <th style={{ width: 240, padding: "12px 6px" }}>EMAIL</th> */}
                <th style={{ width: 240, padding: "12px 6px" }}>CREATED AT</th>
                <th style={{ width: 150, padding: "12px 6px" }}>STATUS</th>
                <th
                  style={{
                    padding: "12px 6px",
                  }}
                    ...
                    <td>
                      ...
                      >
                        <IconButton
                          ...
                          size="sm"
                          onClick={() => {
                            dispatch(setSelectedDoctor(row));
